...
ud95_area <- summary(ud, level.UD=0.95, units=FALSE)$CI[1,2]
...
ud95_rsf_area <- summary(ud_rsf, level.UD=0.95, units=FALSE)$CI[1,2]
...
results <- data.frame(aid, ind_file, ess, ud95_area, ud50_area, pct95, pct50, ud95_rsf_area, ud50_rsf_area, pct95_rsf, pct50_rsf)
